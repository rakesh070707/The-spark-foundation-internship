...
<body style="background:green;background-size: 100%">
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welcome to Ministry Council Bank </h4>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      ...
      <div class="col">
        ...
        <div class="card-body">
          <a href="transfer.php" class="btn btn-outline-success btn-block">Money Transfer</a>
         </div>
        </div>
      </div>
    </div>
